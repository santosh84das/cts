...
import {
    PensionFirstBillServiceInterface
} from './pensionFirstBill.serviceInterface';
...
export class PensionFirstBillService implements PensionFirstBillServiceInterface {
