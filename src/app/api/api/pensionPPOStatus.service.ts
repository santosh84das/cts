...
import {
    PensionPPOStatusServiceInterface
} from './pensionPPOStatus.serviceInterface';
...
export class PensionPPOStatusService implements PensionPPOStatusServiceInterface {
