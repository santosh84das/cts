...
import {
    PensionComponentServiceInterface
} from './pensionComponent.serviceInterface';
...
export class PensionComponentService implements PensionComponentServiceInterface {
